...
class EfficientNetB0(tf.keras.Model): 
    def __init__(self,n_class , *args, **kwargs):
        super(EfficientNetB0, self).__init__(*args, **kwargs)
...
ModelEffNetB0 = EfficientNetB0(2)
model_dir = "./Project Car Detection EfficientNet/EffNetB0.weight.h5"
print(ModelEffNetB0(tf.random.normal((1,30,30,3))))
ModelEffNetB0.load_weights(model_dir)
...
def is_empty_spot(spot_image):
    ...
    decision_scores = ModelEffNetB0(resized_image2)
